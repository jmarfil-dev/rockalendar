...
INSERT INTO moderation_rules (id, rule_type, value, reason, active, created_at) VALUES
    ...
    (gen_random_uuid(), 'TEXT_TERM', 'love reggaeton',      'Festival de Superstruct', true, now()),
    ...
    (gen_random_uuid(), 'TEXT_TERM', 'love the twenties',   'Festival de Superstruct', true, now()),
    (gen_random_uuid(), 'TEXT_TERM', 'love the 90s',        'Festival de Superstruct', true, now()),
    ...
    (gen_random_uuid(), 'TEXT_TERM', 'vina rock',           'Festival de Superstruct', true, now()),
    (gen_random_uuid(), 'TEXT_TERM', 'monegros',            'Festival de Superstruct', true, now()),
    ...
    (gen_random_uuid(), 'TEXT_TERM', 'tsunami',             'Festival de Superstruct', true, now()),
