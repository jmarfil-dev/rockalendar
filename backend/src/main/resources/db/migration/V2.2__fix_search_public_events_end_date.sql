-- ============================================================
-- Flyway: actualizar funciones de búsqueda pública tras migración end_date
-- Version: 2.2
-- Description: Sustituye las referencias a end_date_time (eliminado en V2.0.0.1)
--   por end_date (DATE) en search_public_events y search_public_events_fallback.
-- ============================================================
